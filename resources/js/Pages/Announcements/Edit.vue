<template>
  <AppLayout>
    <div class="max-w-2xl">
      <h1 class="text-2xl font-bold text-slate-900 tracking-tight mb-6">お知らせ編集</h1>
...
const form = useForm({
  ...
  target_type: props.announcement.target_type,
  target_id: props.announcement.target_id ? String(props.announcement.target_id) : '',
  publish_now: props.announcement.published_at !== null,
});
