<template>
  <AppLayout>
    <div class="max-w-4xl">
      <h1 class="text-2xl font-bold text-gray-900 mb-6">テスト作成</h1>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              class="block w-full rounded border px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:ring-1 focus:outline-none transition-colors"
          ...
          <div class="grid grid-cols-3 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">
                制限時間（分）
                <span class="text-xs text-gray-400 font-normal">（任意、空欄=無制限）</span>
              </label>
              <input
          ...
          >
            ...
            <div class="mb-4">
              ...
              <textarea
                ...
                class="block w-full rounded border border-gray-300 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none resize-none"
              />
            </div>
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  <input
                    ...
                    required
                    placeholder="選択肢を入力"
                    class="flex-1 rounded border border-gray-300 px-3 py-1.5 text-sm text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
...
function defaultQuestion(): QuestionForm {
  return {
    body: '',
    score: 1,
